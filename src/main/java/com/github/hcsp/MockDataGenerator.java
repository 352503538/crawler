        ...
        try (SqlSession session = sqlSessionFactory.openSession(ExecutorType.BATCH)) {
            ...
            try {
                while (count-- > 0) {
                    ...
                    Instant cuttentTime = newsToBeInserted.getCreatedAt();
                    cuttentTime = cuttentTime.minusSeconds(random.nextInt(3600 * 24 * 365));
                    newsToBeInserted.setCreatedAt(cuttentTime);
                    newsToBeInserted.setModifiedAt(cuttentTime);
